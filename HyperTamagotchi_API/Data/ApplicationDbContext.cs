...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext(options)
{
    ...
    //            new IdentityRole { Id = customerRoleId, Name = "Customer", NormalizedName = "Customer".ToUpper() }
    //        );
    //    }

    //    if (!await Address.AnyAsync())
    //    {
    //        await Address.AddRangeAsync(
    //            new Address { AddressId = 1, StreetAddress = "Timmermansgatan 2A", City = "Kiruna", ZipCode = "98137" },
    //            new Address { AddressId = 2, StreetAddress = "Rundvägen 11D", City = "Örnsköldsvik", ZipCode = "89144" }
    //        );
    //    }

    //    if (!await ShoppingCarts.AnyAsync())
    //    {
    //        await ShoppingCarts.AddRangeAsync(
    ...
    //    if (!await ShoppingItems.AnyAsync())
    //    {
    //        await ShoppingItems.AddRangeAsync(
    //            new ShoppingItem
    //            {
    //                ShoppingItemId = 1,
    ...
    //    if (!await Tamagotchis.AnyAsync())
    //    {
    //        await Tamagotchis.AddRangeAsync(
    //            new Tamagotchi
    //            {
    //                ShoppingItemId = 16,
    //                Name = "Rocker Rick",
